...
func main() {
	...
	// Join paths using filepath.foin
	...
	fmt.Println("Is relativePath var absolute:", filepath.IsAbs(relativePath))
	fmt.Println("Is absolutePath var absolute:", filepath.IsAbs(absolutePath))
